    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 relative z-10">
        <div class="text-center mb-14 reveal">
            ...
            <h2 class="section-heading">
                Cerita dari yang sudah memesan
            </h2>
            <p class="section-desc mt-4">
                Dari undangan nikah sampai pesta si kecil — mereka bilang link-nya langsung bikin tamu antusias.
            </p>
        </div>
        ...
        <div class="relative reveal">
            <div id="testimonial-track" class="testimonial-track">
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-city">Wedding · Yogyakarta</p>
                </div>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">
                        Ultah anak kami jadi lebih seru — temannya pada antusias buka undangan, RSVP-nya juga rapi.
                    </p>
                    <p class="testimonial-name">Ibu Sinta · Kirana</p>
                    <p class="testimonial-city">Ultah Anak · Semarang</p>
                </div>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-city">Couple · Jakarta</p>
                </div>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-city">Wedding · Bandung</p>
                </div>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">
                        Harganya worth it. Dari konsultasi sampe jadi, komunikasinya enak. Recommended buat yang pengen undangan anti-ribet.
                    </p>
                    <p class="testimonial-name">Nadia &amp; Kevin</p>
                    <p class="testimonial-city">Wedding · Surabaya</p>
                </div>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">
                        RSVP online-nya ngebantu banget ngehitung jumlah tamu. Buku ucapannya juga ramai diisi keluarga dari luar kota.
                    </p>
                ...
                <div class="testimonial-card">
                    ...
                    <p class="testimonial-text">
                        Tema dark elegant-nya sesuai banget sama mood kami. Link-nya gampang dishare, orang tua juga bisa buka di HP.
                    </p>
