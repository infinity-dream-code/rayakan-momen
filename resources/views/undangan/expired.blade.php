...
<head>
    ...
    <style>
        body { margin:0; min-height:100vh; display:flex; align-items:center; justify-content:center;
            font-family: Poppins, sans-serif; background:#0e1320; color:#fff; text-align:center; padding:24px; }
        h1 { font-family: 'Playfair Display', serif; font-size: clamp(1.6rem, 4vw, 2.4rem); margin:0 0 12px; }
        p { color: rgba(255,255,255,.65); max-width: 28rem; line-height:1.6; margin:0 auto 24px; }
