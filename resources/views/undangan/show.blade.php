...
<head>
    ...
    <style>
        ...
        .nav-bottom a:hover, .nav-bottom a.active {
            background: var(--accent); color: {{ $isDark || $isClassic ? '#1a1510' : '#fff' }};
        }
        .form-field {
        ...
        .btn-accent {
            background: var(--accent); color: {{ $isDark || $isClassic ? '#1a1510' : '#fff' }};
            font-weight: 600; border-radius: 999px; padding: 0.8rem 1.5rem;
    ...
    <div id="isi-undangan" class="hidden">
        ...
        @if (!empty($undangan['rekening']))
            <section id="gift" class="section-block">
                ...
                <p class="text-sm text-center mb-6 max-w-xs mx-auto" style="color:var(--muted)">Doa restu Anda sangat berarti. Jika berkenan, dapat melalui rekening berikut.</p>
                <div class="space-y-3">
