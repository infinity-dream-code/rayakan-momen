@php
    ...
    $tanggalFormatted = $tanggalUtama
        ? \Illuminate\Support\Carbon::parse($tanggalUtama)->locale('id')->translatedFormat('l ù d F Y')
        : null;
@endphp
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>{{ $undangan['nama_wanita'] }} & {{ $undangan['nama_pria'] }} ù Undangan Pernikahan</title>
