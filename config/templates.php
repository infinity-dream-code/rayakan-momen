    ...
    */
    'templates' => [
        ...
        'elegan' => [
            ...
            'aktif' => true,
            'fields' => [
                'mempelai', 'ortu_mempelai', 'foto_mempelai',
                'akad', 'resepsi', 'maps',
        ...
        'adat_jawa' => [
            ...
            'kategori' => 'wedding',
            'nama' => 'Adat Jawa',
            'deskripsi' => 'Nuansa tradisional Jawa — khidmat, budaya, dan elegan. Preview segera hadir.',
            'warna' => '#6b3a2a',
            'harga' => 350000,
            'preview' => null,
            'file' => null,
        ...
        'ultah_candyland' => [
            ...
            'aktif' => true,
            'fields' => [
                'anak', 'ortu_host', 'foto_anak',
                'acara_pesta', 'maps', 'dress_code', 'jadwal',
                'kutipan', 'youtube', 'galeri',
            ],
        ],
        ...
        'ultah_bintang' => [
            ...
            'fields' => [
                'anak', 'ortu_host', 'foto_anak',
                'acara_pesta', 'maps', 'dress_code',
                'kutipan', 'cerita', 'youtube', 'galeri',
            ],
        ],
        ...
        'couple_surat' => [
            ...
            'aktif' => true,
            'fields' => [
                'couple_nama', 'tanggal_spesial', 'surat_janji', 'alasan_sayang',
                'foto_couple', 'kutipan', 'youtube', 'galeri',
            ],
        ],
    ],
];
